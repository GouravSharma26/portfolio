  ...
  return (
    <div className="w-full bg-gradient-to-br from-white via-gray-100 to-white py-16">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <button
          onClick={scrollLeft}
          className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-white/90 backdrop-blur-md border border-gray-300 shadow-lg p-3 rounded-full hover:bg-indigo-50 transition-all z-10"
        >
        ...
        <button
          onClick={scrollRight}
          className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-white/90 backdrop-blur-md border border-gray-300 shadow-lg p-3 rounded-full hover:bg-indigo-50 transition-all z-10"
        >
